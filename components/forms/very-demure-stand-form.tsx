...
export default function VeryDemureStandForm() {
	...
	return (
		<form
			...
			className="text-slate-500 font-extrabold flex flex-col text-xl"
		>	
			{/* <Controller
				control={control}
				rules={{
				...
				render={({  }) => (
					<Incrementor name="test" {...control} />
				)}
			/> */}
			<Incrementor name="match" control={control} rules={{ required: true }} />
      ...
      <br/>
			...
			<input
				type="checkbox"
				{...register("leftstartzone", { required: true })}
			/>
			<label>Auto Speaker Scored</label>
			<input
				defaultValue="0"
				{...register("autospeakerscored", { min: 0, valueAsNumber: true })}
			/>
			<label>Auto Speaker Missed</label>
			<input
				defaultValue="0"
				{...register("autospeakermissed", { min: 0, valueAsNumber: true })}
			/>
			<label>Auto Amp Scored</label>
			<input
				defaultValue="0"
				{...register("autoampscored", { min: 0, valueAsNumber: true })}
			/>
			<label>Auto Amp Missed</label>
			<input
				defaultValue="0"
				{...register("autoampmissed", { min: 0, valueAsNumber: true })}
			/>
			<label>Teleop Speaker Scored</label>
			<input
				defaultValue="0"
				{...register("teleopspeakerscored", { min: 0, valueAsNumber: true })}
			/>
			<label>Teleop Speaker Missed</label>
			<input
				defaultValue="0"
				{...register("teleopspeakermissed", { min: 0, valueAsNumber: true })}
			/>
			<label>Teleop Amp Scored</label>
			<input
				defaultValue="0"
				{...register("teleopampscored", { min: 0, valueAsNumber: true })}
			/>
			<label>Teleop Amp Missed</label>
			<input
				defaultValue="0"
				{...register("teleopampmissed", { min: 0, valueAsNumber: true })}
			/>
			<label>Teleop Trap Scored</label>
			<input
				defaultValue="0"
				{...register("teleoptrapscored", { min: 0, valueAsNumber: true })}
			/>
			<label>Teleop Trap Missed</label>
			<input
				defaultValue="0"
				{...register("teleoptrapmissed", { min: 0, valueAsNumber: true })}
			/>
			<label>Endgame</label>
			...
			<input
				defaultValue="0"
				{...register("fouls", { min: 0, valueAsNumber: true })}
			/>
			<label>Tech Fouls</label>
			<input
				defaultValue="0"
				{...register("techfouls", { min: 0, valueAsNumber: true })}
			/>
			<label>Notes</label>
